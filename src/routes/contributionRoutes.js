...
router.post('/', authMiddleware, requireGroup, requireRoles('admin', 'treasurer'), contributionController.addContribution);
...
router.put('/:id', authMiddleware, requireGroup, requireRoles('admin', 'treasurer'), contributionController.updateContribution);
router.delete('/:id', authMiddleware, requireGroup, requireRoles('admin'), contributionController.deleteContribution);
